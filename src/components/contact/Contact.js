  ...
  const onSubmit = (e) => {
    ...
    send(
      ...
      .then((response) => {
        ...
        setToSend({message: ""})
        setToSend({reply_to: ""})
        window.alert("Message sent successfully to Oindrila")
      })
      .catch((err) => {
        ...
        <div className='main-content'>
          <div className='left-container'>
            <div className='banner'>
              <h1>Get in touch with Oindrila</h1>
              <h4>
          ...
          <div className='right-container'>
            ...
            <div className='contact-info'>
              <h2>Contact Info</h2>
              <h3>Contact Oindrila Das</h3>
            </div>
            <div className='contact-details'>
              <p>
                <strong>Email: </strong>
                oindrila.das2708@gmail.com
              </p>
              <p>
                <strong>Phone: </strong>
                +91-8777092227
              ...
              <ul className='socials'>
                <li>
                  <a href='https://www.linkedin.com/in/oindriladas02/'>
                    Linkedin
                  </a>
                </li>
                <li>
                  <a href='https://github.com/OindrilaDas27'>GitHub</a>
                </li>
                <li>
